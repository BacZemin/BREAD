...
# Prime the ExperimentHub-backed caches on fresh systems (e.g. CI).
# Using the actual Get / getDBs API calls makes this version-safe.
sesameData::sesameDataCache(c("HM450.76.TCGA.matched", "HM450.probeInfo"))
invisible(knowYourCG::getDBs(c(
